    ...
    def __init__(self):
        ...
        try:
            self.connection = psycopg2.connect(
                dbname='ddsthpcuglj625', user='cnoylwtnmdhivr', host='ec2-174-129-236-147.compute-1.amazonaws.com', password='ed83a099ef0e3afbce27a593ba489fa177a11a4006107effd2ec86447a3a05c6)
